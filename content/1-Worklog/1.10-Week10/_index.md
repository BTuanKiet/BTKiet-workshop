...
### Week 10 Objectives
- Practice infrastructure as code with AWS CDK.
- Build automated CI/CD pipelines for modern applications.
- Learn hybrid storage and high-performance Windows file services.
...
- Implemented CI/CD pipelines for EKS, ECS, and EC2 using CodePipeline and related services.
- Explored AWS Storage Gateway for hybrid on-premises and cloud storage.
- Tested Amazon FSx for Windows with high-availability and file share features.

### Key achievements
- Gained a stronger understanding of IaC and DevOps workflows in AWS.
- Learned how CI/CD improves deployment consistency and operational reliability.
- Understood the role of hybrid storage and managed file systems in enterprise environments.
